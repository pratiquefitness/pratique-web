    ...
    <Loading spinning={loading}>
      <div className="text-center">
        ...
        <img
          ...
          height={20}
        />{' '}
        {dadosAluno.user_email === 'pratadeu@gmail.com' ||
        dadosAluno.user_email === 'edujobtours@hotmail.com' ||
        dadosAluno.user_email === 'glauberpratique@hotmail.com' ? (
          <img
            src={`/images/banner_home/${
              dadosAluno.user_email === 'adelmo2@gmail.com' ? 'adelmo.jpg' : 'icone-anovator.png'
            }`}
            className="mb-4"
            height={60}
            margingLeft={40}
